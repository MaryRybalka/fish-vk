...
<template>
  <div class="relative flex items-top justify-center min-h-screen sm:items-center sm:pt-0">
    <div
      class="max-w-[720px] min-h-[448px] bg-white overflow-hidden sm:rounded-lg border-[1px] border-gray-200 flex flex-row">
      <div class="w-1/2 bg-[#f9f9f9] p-7">
        <div class="flex flex-row items-start items-center mb-3">
          <img src="/logo.png" alt="" class="h-5 w-5">
          <p class="font-normal ml-1">ID</p>
        </div>
        <h1 class="font-normal text-lg mt-3 mb-[18px] leading-[1.33]">ВКонтакте можно войти <br> через VK ID</h1>
        <ul class="flex flex-col items-start">
          <li class="element">
            <div class="w-7 h-7 mr-3">
              <svg width="28" height="28" xmlns="http://www.w3.org/2000/svg" class="text-gray-400">
            ...
            <p class="text-[#6d7885] text-sm tracking-wide">Единый аккаунт для сервисов VK <br> и партнёров</p>
          </li>
          <li class="element">
            <div class="w-7 h-7 mr-3">
              <svg fill="none" height="28" width="28" xmlns="http://www.w3.org/2000/svg" class="text-gray-400">
            ...
            <p class="text-[#6d7885] text-sm tracking-wide">Быстрый вход в одно нажатие</p>
          </li>
          <li class="element">
            <div class="w-7 h-7 mr-3">
              <svg width="28" height="28" xmlns="http://www.w3.org/2000/svg" class="text-gray-400">
            ...
            <p class="text-[#6d7885] text-sm tracking-wide">Надёжная защита с привязкой <br> к телефону</p>
          </li>
        </ul>

      </div>
      <form class="w-1/2 flex flex-col items-center p-7 text-center justify-between">
        <div class="flex flex-col items-center">
          <img src="/logo.png" alt="" class="h-12 w-12 my-3">
          <h1 class="font-medium text-xl mb-4">Введите номер</h1>
          <p class="text-[#6d7885] mb-4 text-[15px] leading-5">Ваш номер телефона будет использоваться для входа в
                                                               аккаунт</p>
          <input
            type="text"
        ...
        <div class="flex flex-col">
          <button
            type="submit"
            :disabled="(login==='' || pass==='')"
                  class="mb-4 text-white rounded-lg px-3 py-2 bg-[#4986cc]"
                  :class="`${(login==='' || pass==='')? 'cursor-default opacity-50' : 'cursor-pointer opacity-100'}`"
          >
            Продолжить
          </button>
          <div>
            <p class="text-[11px] text-gray-400">
              Нажимая «Продолжить», вы принимаете <span class="text-[#6d7885]">пользовательское соглашение</span> и
              <span
                class="text-[#6d7885]">политику конфиденциальности</span>.
            </p>
          </div>
        </div>
      </form>
...
<style scoped>
.element {
  @apply flex flex-row py-2 mb-[2px] items-center;
}
</style>
